package com.zc.kindergarten.usercenter.aop;
...
public class RequestPrint {
     ...
     * 方法调用前触发 记录开始时间
     */
    @Before("execution(* com.zc.kindergarten.usercenter.controller..*.*(..))")
     ...
     * 方法调用后触发 记录结束时间
     */
    @After("execution(* com.zc.kindergarten.usercenter.controller..*.*(..))")
     ...
     * 环绕触发
     */
    @Around("execution(* com.zc.kindergarten.usercenter.controller..*.*(..))")
