package com.zc.kindergarten.tool.search.lucene;

import com.zc.kindergarten.common.msg.ResponseEntity;
import com.zc.kindergarten.common.vo.IndexObject;
import com.zc.kindergarten.tool.search.lucene.util.DocumentUtil;
import com.zc.kindergarten.tool.search.lucene.util.IKAnalyzer5x;
import com.zc.kindergarten.tool.search.lucene.util.QueryUtil;
...
public class LuceneDao {
	...
	/* 查询索引 */
	public ResponseEntity<IndexObject> page(Integer pageNumber, Integer pageSize, String keyword) {

		IndexReader indexReader = null;
		ResponseEntity<IndexObject> pageQuery = null;
		...
		try {
			...
			//topDocs.totalHits总条数可返回
			pageQuery = new ResponseEntity(searchResults);
